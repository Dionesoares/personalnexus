...
export default function PixProfessorConfig({ professorId }) {
  ...
  const [pixForm, setPixForm] = useState(() => loadPixProfessor(professorId) || pixDefault);
        ...
        <div className="space-y-3">
          ...
          <div className="flex gap-2">
            <button onClick={salvar}
              ...
              style={{ background: pixSaved ? '#34d39920' : '#34d39920', color: pixSaved ? '#34d399' : '#34d399', border: `1px solid ${pixSaved ? '#34d39940' : '#34d39930'}` }}>
