    ...
    <div className="min-h-screen flex" style={{ background: '#0a0e1a' }}>
      ...
      <div className="hidden lg:flex flex-col justify-between w-[45%] p-12 relative overflow-hidden"
        ...
        <div className="flex items-center gap-4">
          <img src="https://media.base44.com/images/public/69ea31515b70bc9ef16762b9/8d69b3525_RosaeVerdeIlustradoDiadaMulherCarto1.jpg" alt="Personal Fit Up" className="w-28 h-28 object-contain flex-shrink-0" style={{}} />
      ...
      <div className="flex-1 flex items-center justify-center p-6">
        <div className="w-full max-w-md">
          <div className="lg:hidden flex items-center gap-3 mb-8 justify-start">
            <img src="https://media.base44.com/images/public/69ea31515b70bc9ef16762b9/8d69b3525_RosaeVerdeIlustradoDiadaMulherCarto1.jpg" alt="Personal Fit Up" className="w-20 h-20 object-contain flex-shrink-0" style={{}} />
